...
class Vgg19:
    ...
    def __init__(self,
        ...
        red, green, blue = tf.split(self._inputRGB, 3, 3)
        self._inputBGR = tf.concat(axis=3, values = [
            blue,
            green,
            red,
        ])
        ...
        # variances.
        # Size: 224x224x3
        self._inputNormalizedBGR = tf.concat(axis = 3, values = [
            blue - _VGG_MEAN[0],
            green - _VGG_MEAN[1],
            red - _VGG_MEAN[2],
        ])
        ...
        # For training.
        self._loss = tf.nn.softmax_cross_entropy_with_logits(logits = self._fc8,
