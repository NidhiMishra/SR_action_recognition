...
Steps to run Pykinect2 libraries with 64-bit Anaconda version:

1. Move to "Lib/site-packages/pykinect2/PyKinectV2.py"
2. At line 2216, comment assert sizeof(tagSTATSTG) == 72, sizeof(tagSTATSTG)
